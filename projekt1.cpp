...
void napisOkno() {
    switch (n) {
    case 0:SetWindowText(hText, L"0");
        break;
    case 50:SetWindowText(hText, L"50");
        break;
    case 100:SetWindowText(hText, L"100");
        break;
    case 150:SetWindowText(hText, L"150");
        break;
    case 200:SetWindowText(hText, L"200");
        break;
    case 250:SetWindowText(hText, L"250");
        break;
    case 300:SetWindowText(hText, L"300");
        break;
    case 350:SetWindowText(hText, L"350");
        break;
    case 400:SetWindowText(hText, L"400");
        break;
    case 450:SetWindowText(hText, L"450");
        break;
    case 500:SetWindowText(hText, L"500");
        break;
    case 550:SetWindowText(hText, L"550");
        break;
    case 600:SetWindowText(hText, L"600");
        break;
    default:SetWindowText(hText, L"nie ma tylu danych");
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   hwndButton = CreateWindow(TEXT("button"),                      // The class name required is button
       ...
       WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,  // the styles
       700, 400,                                  // the left and top co-ordinates
       150, 30,                              // width and height
       hWnd,                                 // parent window handle
   ...
   hwndButton = CreateWindow(TEXT("button"),                      // The class name required is button
       TEXT("ilosc probek -50"),                  // the caption of the button
       WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,  // the styles
       700, 450,                                  // the left and top co-ordinates
       150, 30,                              // width and height
       hWnd,                                 // parent window handle
   ...
   hText = CreateWindowEx(WS_EX_CLIENTEDGE, L"EDIT", NULL, WS_CHILD | WS_VISIBLE | WS_BORDER |
       WS_VSCROLL | ES_MULTILINE | ES_AUTOVSCROLL, 900, 400, 200, 50,hWnd, NULL, hInstance, NULL);
